            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
              {templates.map((template) => {
                ...
                >
                  ...
                  {isPromo && !isOferta && (
                    <div style={{ background: `linear-gradient(90deg, ${temaStyles.accentColor || '#dc2626'}, ${temaStyles.accentColor ? temaStyles.accentColor + 'cc' : '#ea580c'})`, padding: '6px 16px', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6 }}>
                      <span style={{ color: '#fff', fontSize: 11, fontWeight: 800, letterSpacing: '1px', textTransform: 'uppercase' }}>{themeEmoji} {themeName} — Condições Exclusivas</span>
                    </div>
                  )}
