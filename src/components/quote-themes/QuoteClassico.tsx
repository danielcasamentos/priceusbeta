  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-gradient-to-br from-blue-50 via-white to-green-50">
      <div className="max-w-4xl mx-auto px-4 py-8 sm:py-12">
        {profile && (
          <div className="bg-white rounded-3xl shadow-2xl overflow-hidden mb-8 border-4 border-blue-200">
            <div className="bg-gradient-to-r from-blue-600 to-green-600 h-24"></div>
        ...
        <div className="bg-white rounded-3xl shadow-2xl p-6 sm:p-8 border-4 border-blue-200">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
                          ...
                          return (
                            <div className="mt-2 flex items-center gap-2 flex-wrap">
                              ...
                              <div className="flex items-center gap-2">
                                ...
                                <span className="text-xl font-bold text-blue-600">{formatCurrency(valorFinal)}</span>
                              </div>
                              {desconto > 0 && (
                      ...
                      {(produto.permite_multiplas_unidades ?? true) ? (
                        <div className="flex items-center gap-3">
                          <button
                            ...
                            className="w-10 h-10 bg-gray-200 hover:bg-gray-300 rounded-lg font-bold disabled:opacity-50"
                          >
                            -
                          </button>
                          ...
                          <button
                            ...
                            className="w-10 h-10 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-bold disabled:opacity-50"
                          >
                            +
                          </button>
                        </div>
                        ...
                        <div className="flex items-center">
                          {produto.obrigatorio ? (
                            <div className="py-2 px-4 bg-blue-50 text-blue-700 rounded-lg text-sm font-semibold">
                              Incluído
                            </div>
                          ) : (
                            <button
            ...
            <div className="bg-gradient-to-r from-blue-50 to-green-50 rounded-xl p-6 text-center border-2 border-blue-200">
              ...
              <p className="text-4xl font-bold text-gray-900">{formatCurrency(calculateTotal())}</p>
            </div>

            <button
              type="submit"
              className="w-full flex items-center justify-center gap-3 bg-gradient-to-r from-blue-600 to-green-600 hover:from-blue-700 hover:to-green-700 text-white px-8 py-4 rounded-xl font-bold text-lg shadow-lg hover:shadow-xl transition-all disabled:opacity-50"
