                  ...
                  >
                        ...
                        {produto.brindes_vinculados && Array.isArray(produto.brindes_vinculados) && produto.brindes_vinculados.length > 0 && (
                          <div style={{ marginTop: 10, paddingTop: 10, borderTop: '1px dashed rgba(255,255,255,.08)' }}>
                            <div style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'space-between', gap: 6, marginBottom: 6 }}>
                              <span style={{ fontSize: 10, fontWeight: 800, color: '#34d399', display: 'flex', alignItems: 'center', gap: 6, textTransform: 'uppercase', letterSpacing: '1px' }}>
                        ...
                        {!template?.ocultar_valores_intermediarios && (() => {
                          ...
                          return (
                            <div style={{ marginTop: 4, display: 'flex', alignItems: 'center', gap: 8, flexWrap: 'wrap' }}>
                              {desconto > 0 && (
                                <span style={{ background: 'rgba(34,197,94,.15)', color: '#22c55e', fontSize: 10, fontWeight: 700, padding: '2px 6px', borderRadius: 4 }}>
                                  🏷️ {desconto}% OFF
                                </span>
                              )}
                              <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                                ...
                                <span style={{ fontSize: 17, fontWeight: 800, color: '#22c55e' }}>{formatCurrency(valorFinal)}</span>
                              </div>
                              {desconto > 0 && (
                                <span style={{ fontSize: 11, color: '#22c55e', fontWeight: 600 }}>Economia de {formatCurrency(produto.valor - valorFinal)}</span>
                              )}
                            </div>
                          );
                        })()}
                    ...
                    {(produto.permite_multiplas_unidades ?? true) ? (
                      ...
                      <div style={{
                        ...
                        {produto.obrigatorio ? (
                          <div style={{ padding: '6px 16px', background: 'rgba(34,197,94,.1)', border: '1px solid rgba(34,197,94,.2)', color: '#22c55e', borderRadius: 8, fontSize: 13, fontWeight: 600 }}>
                            Incluído
                          </div>
                        ) : (
                          <button
                            ...
                            style={{
                              width: '100%',
                              padding: '10px 16px',
                              background: selectedProdutos[produto.id] ? 'linear-gradient(135deg, #22c55e, #15803d)' : 'rgba(255,255,255,.05)',
