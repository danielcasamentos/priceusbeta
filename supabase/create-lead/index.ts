...
serve(async (req) => {
  ...
  try {
    ...
    // ✅ Validar o payload recebido usando o schema apropriado
    ...
    // 🔒 Criar um cliente Supabase com a service_role.
    ...
    // ✅ Preparar o objeto para ser inserido na tabela 'leads'
    const leadData = {
    ...
    // ✅ Criar a notificação para o usuário (fotógrafo)
    if (newLead) {
